...
//         <form onSubmit={handleSignUp}  className='w-[90%] h-[600px] max-w-[500px] bg-[#00000059] backdrop-blur-md shadow-lg shadow-black flex flex-col items-center justify-cemter gap-[20px] px-[20px] ' >
...
//         <input type="text" placeholder='Enter Your Name' className='w-full h-[60px] outline-none border-2 border-white bg-transparent text-white placeholder-gray-300 px-[20px] py-[20px] rounded-full text-[18px] 'required onChange={(e)=>setName(e.target.value)} value={name} />
...
//         {err.length>0 && <p className='text-red-500 text-[87px]'>*{err}</p>}

//         <button type="submit"  className='min-w-[150px] h-[60px] bg-white rounded-full text-black-semibold bg-white rounded-full text-[19px] 'disabled={loading}> { loading? "Loading..." :"Sign UP"} 
//         </button>
        

//         <p className='text-white text-[18px] cursor-pointer  ' onClick={()=>navigate("/signin")}>Already have a account? <span className='text-blue-400'>Sign In</span></p>
  ...
  return (
    ...
    >
      <form
        ...
        className='w-[90%] h-[600px] max-w-[500px] bg-[#00000059] backdrop-blur-md shadow-lg shadow-black flex flex-col items-center gap-[20px] px-[20px]'
      >
        <h1 className='text-white text-[30px] font-semibold mt-[100px]'>
        ...
        {err.length > 0 && (
          <p className='text-red-500 text-[17px] font-medium'>*{err}</p>
        )}
